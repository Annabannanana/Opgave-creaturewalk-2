...
//Anna kommentar - Jeg ændrer variablerne int til float så øjnene sidder stille og fordi vi arbejder med hele tal, ikke kommatal
...
void draw() {                         
  //Anna kommentar - Jeg fjerner de to skråstreger som gjorde float ballwalk funktionen til en kommentar
